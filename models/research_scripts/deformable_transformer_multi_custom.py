# ------------------------------------------------------------------------
# Not used in the Thesis, but used for testing purposes and research purposes.
...
class DeformableTransformer(nn.Module):
    def __init__(self, d_model=256, nhead=8,
        ...
        self.temporal_encoder_layer =  TemporalDeformableTransformerEncoderLayer(d_model, dim_feedforward,
                                                          dropout, activation,
                                                          num_ref_frames, nhead, enc_n_points * enc_n_points)
        # self.temporal_encoder_layer =  TemporalDeformableTransformerEncoderLayer(d_model, dim_feedforward,
        #                                                   dropout, activation,
    ...
    def forward(self, srcs, masks, pos_embeds, query_embed=None, class_embed = None ):
        ...
        memory = self.temporal_encoder_layer(cur_memory, cur_pos_embed, reference_points, ref_memory, ref_spatial_shapes,frame_start_index)
