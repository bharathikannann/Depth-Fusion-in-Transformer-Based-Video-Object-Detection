...
class BackboneBase(nn.Module):
    ...
    def __init__(self, backbone: nn.Module, train_backbone: bool, return_interm_layers: bool):
        ...
        self.name = self.rgb_name = 'resnet50'
        self.d_name = 'resnet18'
        ...
        if return_interm_layers:
            getter_return_layers = {"layer2": "0", "layer3": "1", "layer4": "2"}
            self.strides = [8, 16, 32]
            self.num_channels = [512, 1024, 2048]
        else:
            getter_return_layers = {'layer4': "0"}
            self.strides = [32]
            self.num_channels = [2048]
        self.body = IntermediateLayerGetter(backbone, return_layers=getter_return_layers)
...
def build_backbone(args):
    ...
    backbone = Backbone(args.backbone, train_backbone, return_interm_layers, args.dilation, args.depth_type)
